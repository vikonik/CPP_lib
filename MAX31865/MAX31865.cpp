...
#include <stdlib.h>
#include "core_cm1.h"                   // Keil::Device:Startup
#include "math.h"


/**************************************************************************/
/*!
    @brief Используем толко аппаратный SPI
    @param spi_cs пин для выбора устройства
*/
/**************************************************************************/
 MAX31865:: MAX31865(SPI *spi, PortMapIO *spi_cs)
    : spi_dev(spi),spi_cs(spi_cs) {}
...
*/
/**************************************************************************/
double  MAX31865::temperature(double RTDnominal, double refResistor) {
